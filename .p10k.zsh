# Generated by Powerlevel10k configuration wizard on 2023-08-05 at 09:50 CST.
...
() {
  ...
  [[ "$(uname)" == "Linux" ]] && typeset -g POWERLEVEL9K_MODE=nerdfont-complete
  [[ "$(uname)" == "Darwin" ]] && typeset -g POWERLEVEL9K_MODE=nerdfont-v3
